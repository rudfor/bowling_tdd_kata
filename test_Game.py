...
test_data = [
    ...
    (240,   [[10], [10], [10], [10], [10], [10], [10], [10], [10], [0, 0]], ""),
    (275,   [[10], [10], [10], [10], [10], [10], [10], [10], [10], [5, 5, 10]], ""),
    (265,   [[10], [10], [10], [10], [10], [10], [10], [10], [10], [5, 5, 0]], ""),
    # Perfect Game
    (0, None, ""),
]
...
def test_score(score, score_array, expected):
    if type(score) is int:
        ...
        print(f"{g.score} - {score} - {score_array} - { expected }")
        assert (g.score == score)
    else:
        print(f"{score} - {score_array} - { expected }")
